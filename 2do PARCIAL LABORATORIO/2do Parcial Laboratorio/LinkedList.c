 ...
 * \return Node* Retorna  (NULL) Error: si el puntero a la lista es NULL o (si el indice es menor a 0 o mayor al len de la lista)
                 Retorna  (pElement) Si funciono correctamente
 *
 */
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    if(this!=NULL)
    {
        auxNode = this->pFirstNode; // nodo numero 0;
        size = ll_len(this);
        if(nodeIndex==0)
        {
                pNode = auxNode;
        ...
        else if(nodeIndex>0 && nodeIndex<size)
        {
            ...
            {
                pNode = auxNode->pNextNode; //auxNode apunta al nodo 1 en la primer iteracion
                auxNode = pNode;
                contador++;
            }
        }
...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    sizeOfLL = ll_len(this);
    if(nodeIndex<0||nodeIndex>sizeOfLL)
    {
        return returnAux;
    }
...
int ll_add(LinkedList* this, void* pElement)
{
    ...
    {
        lenLL=ll_len(this);
        control = addNode(this,lenLL,pElement); //agrega el elemento dentro de un nodo nuevo al final de la LL
        if(control != -1)
        {
            returnAux=0;
        }
 ...
 * \return int Retorna  (-1) Error: si el puntero a la lista es NULL
                        ...
                        (-1) si no encuentra encuentra el indice del elemento
 *
 */
